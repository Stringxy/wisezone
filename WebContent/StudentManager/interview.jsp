...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/StudentManager/interview.js"></script>
<script type="text/javascript"
...
function tz() {
	window.location.href="${pageContext.request.contextPath}/studentManager/Interview!AddInterview.action";
	}
							...
							<table class="display"
								...
								<tfoot>
									<tr>
										...
										<th><input type="text" placeholder="按学员姓名查询" /></th>
										<th><input type="text" placeholder="按班级查询" /></th>
										<th><input type="text" placeholder="按教师查询" /></th>
										<th></th>
										<th></th>
										<th><input type="text" placeholder="按跟进查询" /></th>
										<th></th>
										<th></th>
									</tr>
								</tfoot>
	...
	<div class="col-md-9 col-sm-12 col-xs-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath }/studentManager/Interview!downloadTemp.action">下载Excel模板</a>
				<br><br>
				 <label
