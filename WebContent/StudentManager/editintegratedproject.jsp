...
<div id="page-inner">
       ...
       <div class="panel panel-primary">
		    ...
		    <div class="panel-body">
		       ...
		       <form name="form1" method="post" action="${pageContext.request.contextPath }/studentManager/IntegratedProject!ipEditSave.action" class="form-horizontal" role="form">
				  <div class="form-group">
				    <label for="stuId" class="col-sm-2 control-label">学员登录名</label>
				    <div class="col-sm-10">
				     <input type="text" name="stuId" id="stuId" class="form-control"  value="${ip.user.stuName}" readonly="readonly">
				    </div>
				  </div>
				    ...
				    <div class="col-sm-10">
				     <input type="text" name="classesId" id="classesId" class="form-control"  value="${ip.classes.classesName}" readonly="readonly">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control form_datetime" id="createDate1" name="createDate1" 
				         value="<f:formatDate value="${ip.createDate}" type="both" dateStyle="long" pattern="yyyy-MM-dd"/>" readonly >
				    </div>
				  </div>
				   ...
				   <div class="form-group">
				    ...
				    <div class="col-sm-10">
				   <input type="text" name="teamName" id="teamName" class="form-control"  value="${ip.teamName}" >
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				  <input type="text" name="workName" id="workName" class="form-control"  value="${ip.workName}" >
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				  <input type="text" name="evaluatingScore" id="evaluatingScore" class="form-control"  placeholder="请输入项目测评成绩" value="${ip.evaluatingScore}" >
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				  <input type="text" name="answerScore" id="answerScore" class="form-control"  value="${ip.answerScore}" >
				    </div>
				  </div>
				    ...
				    <div class="col-sm-10">
				   <input type="text" name="iDESC" id="iDESC" style="height: 135px;" class="form-control"  value="${ip.iDESC}" >
				    </div>
				  </div>
