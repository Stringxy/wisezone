...
<div id="page-inner">
       ...
       <div class="panel panel-primary">
		    ...
		    <div class="panel-body">
		       ...
		       <form name="form1" method="post" action="${pageContext.request.contextPath }/studentManager/Interview!editSaveIv.action" class="form-horizontal" role="form">
				  <div class="form-group">
				    <label for="stuId" class="col-sm-2 control-label">学员登录名</label>
				    <div class="col-sm-10">
				      <input type="text" name="stuId" id="stuId" class="form-control"  value="${iv.user.stuName}" readonly="readonly">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				      <input type="text" name="classesId" id="classesId" class="form-control"  value="${iv.classes.classesName}" readonly="readonly">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				    <input type="text" name="teacherId" id="teacherId" class="form-control"  value="${iv.teacher.teacherName}" readonly="readonly">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control form_datetime" id="createDate1" name="createDate1" 
				         value="<f:formatDate value="${iv.createDate}" type="both" dateStyle="long" pattern="yyyy-MM-dd"/>" readonly >
				    </div>
				  </div>
				   ...
				   <div class="form-group">
				    ...
				    <div class="col-sm-10">
				   <input type="text" name="information" id="information" class="form-control"  value="${iv.information}">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				   ...
				   <option value="0"
				   <c:if test="${iv.followUp==0 }"> selected="selected"</c:if>
				   >不需要</option>
				   <option value="1"
				   <c:if test="${iv.followUp==1 }"> selected="selected"</c:if>
				   >需要</option>
				    ...
				    <div class="col-sm-10">
				   <input type="text" name="iDesc" id="iDesc" class="form-control"  style="height: 135px;" value="${iv.iDesc}">
				    </div>
				  </div>
