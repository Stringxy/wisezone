...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/StudentManager/employeeinfo.js"></script>
<script type="text/javascript"
...
function tz() {
	window.location.href="${pageContext.request.contextPath}/studentManager/EmployeeInfo!addemp.action";
	}
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">学员就业信息表
	...
	<div class="col-md-9 col-sm-12 col-xs-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath }/studentManager/EmployeeInfo!downloadTemp.action">下载Excel模板</a>
				<br><br>
				 <label
