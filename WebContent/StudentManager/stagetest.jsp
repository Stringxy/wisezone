...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/StudentManager/stagetest.js"></script>
<script type="text/javascript"
...
function tz() {
	window.location.href="${pageContext.request.contextPath}/studentManager/StageTest!addStageTest.action";
	}
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">学员阶段考核成绩表
								...
								<tfoot>
									<tr>
										...
										<th><input type="text" placeholder="按班级查询" /></th>
   										...
   										<th><input type="text" placeholder="按补考查询" /></th>
   										<th></th>
	...
	<div class="col-md-9 col-sm-12 col-xs-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath }/studentManager/StageTest!downloadTemp.action">下载Excel模板</a>
				<br><br>
				 <label
