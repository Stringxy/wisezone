...
<div id="page-inner">
       ...
       <div class="panel panel-primary">
		    ...
		    <div class="panel-body">
		       ...
		       <form name="form1" method="post" action="${pageContext.request.contextPath }/baseManage/addsavemajor.action" class="form-horizontal" role="form">
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				      ...
				      <input type="text" class="form-control" id="majorName" name="majorName" 
				             placeholder="请输入专业名称"   data-bv-trigger='blur' >
				    </div>
				  </div>
