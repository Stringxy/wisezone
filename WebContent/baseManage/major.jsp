...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/baseManage/major.js"></script>

<script type="text/javascript">

function tz() {
	window.location.href="${pageContext.request.contextPath}/baseManage/addmajor.jsp";
	}
